...
const AccommodationCard = (props: any) => {
    ...
    return (
        ...
        <View style={{flexDirection : 'row'}}>
            ...
            <Button mode="outlined" style={{zIndex: 1, justifyContent: 'center', alignItems: 'center', height: 50, width: 'auto', marginVertical: 20, marginHorizontal: 20,}} onPress={() => console.warn("Save accommodation")}> 
